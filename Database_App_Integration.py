...
from AI_Instructor import Instructor
...
@app.get('/topic/<topic>')
def activateAI(topic):
     content=Instructor.showcontent(topic)
     print(content)
     time.sleep(2)
     question=Instructor.askquestion(topic)
     print(question)
     return f"Conetnt:{content}\n\nquestion:{question}"
